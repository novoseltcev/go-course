...
func easyjson2220f231DecodeGithubComNovoseltcevGoCourseInternalSchema(in *jlexer.Lexer, out *Metrics) {
...
func easyjson2220f231EncodeGithubComNovoseltcevGoCourseInternalSchema(out *jwriter.Writer, in Metrics) {
	out.RawByte('{')
	first := true
	_ = first
	{
